...
//                     [disabled]="disabled()"
//                     [(ngModel)]="value"
//                     [class]="'input-base ' + (error() ? 'input-error-state' : '') + (iconLeft() ? ' input-with-icon-left' : '') + (type() === 'password' ? ' input-with-toggle' : '')"
//                     (blur)="blurred.emit()"
//                 />
//                 @if (type() === 'password') {
//                 <button type="button" class="input-toggle" (click)="togglePasswordVisibility()">
//                     @if (isPasswordVisible()) {
//                     <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
